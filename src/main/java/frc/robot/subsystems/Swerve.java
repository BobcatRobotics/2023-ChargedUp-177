...
public class Swerve extends SubsystemBase {
    ...
    public void periodic(){
        ...
        SmartDashboard.putString("odometry", "x: " + swerveOdometry.getPoseMeters().getX() + " y: " + swerveOdometry.getPoseMeters().getY() + " rot: " + swerveOdometry.getPoseMeters().getRotation().getDegrees());
